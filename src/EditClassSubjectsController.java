...
public class EditClassSubjectsController {
    ...
    public EditClassSubjectsController() throws SQLException {
    }
    ...
    public void addSubjects() throws SQLException, IOException {
        try {
            ...
            PreparedStatement pst1 = connection.prepareStatement("DELETE FROM Lectures WHERE Class = ? AND Username = ?");
            pst1.setString(1, EditClassController.className);
            pst1.setString(2, username);
            pst1.executeUpdate();
            pst1.close();
            PreparedStatement pst2 = connection.prepareStatement("DELETE FROM Labs WHERE Class = ? AND Username = ?");
            pst2.setString(1, EditClassController.className);
            pst2.setString(2, username);
            pst2.executeUpdate();
            pst2.close();
            PreparedStatement pst3 = connection.prepareStatement("DELETE FROM Classes WHERE ClassName = ? AND Username = ?");
            pst3.setString(1, EditClassController.className);
